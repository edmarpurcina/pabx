...
/*if (isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] != "http://pabx.wgo.com.br/alertas/index.php"):
...
if (empty($email)):
	$retorno = array('codigo' => '0', 'mensagem' => 'Preencha seu usuariol!');
	echo json_encode($retorno);
	exit();
endif;
...
if ($_SESSION['logado'] == 'SIM'):
	...
	$retorno = array('codigo' => '0', 'mensagem' => 'Usuário não autorizado!' .$email.'--'.$senha);
	echo json_encode($retorno);
	exit();
endif;
